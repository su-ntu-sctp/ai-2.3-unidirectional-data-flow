...
**Key idea to take away:** Before writing any code, ask "which component should own this piece of state?", as the answer is always the closest common ancestor of every component that needs it.
